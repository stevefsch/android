...
public class SketchFrame extends JFrame implements Constants {
  ...
  public SketchFrame(String title, Sketcher theApp) {
    ...
    addMenuItem(elementMenu, ellipseAction = new TypeAction("Ellipse", ELLIPSE, "Draw ellipses"));
    ...
    fillButton = toolBar.add(new FillAction()); 
    fillButton.setSelectedIcon(new ImageIcon("Images/fill.gif"));     // Set the icon for selected state
    fillButton.setBorder(BorderFactory.createRaisedBevelBorder());    // Add button border
...
//  private JButton fillButton = new JButton(new ImageIcon("Images/nofill.gif")); // Fill button
  private JButton fillButton = null;
