...
public class SketchFrame extends JFrame implements Constants {
  ...
  public SketchFrame(String title) {
    ...
    exitAction = new FileAction("Exit", KeyStroke.getKeyStroke('X',Event.ALT_MASK), "Exit");
  ...
  class FileAction extends AbstractAction {    
   ...
   // Constructor
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      // If it is an Exit action call exit() for the frame window
      if(getValue(NAME).equals("Exit"))
        exit();
    }
  }
