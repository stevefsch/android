 ...
 * Original file: F:\\workspace\\android\\MyAndroidServiceSample\\src\\com\\example\\myandroidservicesample\\IPerson.aidl
 */
package com.example.myandroidservicesample;
public interface IPerson extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.example.myandroidservicesample.IPerson
{
private static final java.lang.String DESCRIPTOR = "com.example.myandroidservicesample.IPerson";
...
/**
 * Cast an IBinder object into an com.example.myandroidservicesample.IPerson interface,
 * generating a proxy if needed.
 */
public static com.example.myandroidservicesample.IPerson asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.example.myandroidservicesample.IPerson))) {
return ((com.example.myandroidservicesample.IPerson)iin);
}
return new com.example.myandroidservicesample.IPerson.Stub.Proxy(obj);
}
...
private static class Proxy implements com.example.myandroidservicesample.IPerson
{
