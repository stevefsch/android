...
/*
 The inner Selection class no longer implements the ActionListener interface. The
 Selection class has a new method, newSelection() that obtains a new value for the
 button. This method is called by the mouse handler in response to a MOUSE_PRESSED
 event.
 */
...
public class Lottery extends JApplet {
	  ...
	  final static int maxValue = 36;                     // Maximum in range
  ...
  public void init() {
    ...
    for(int i = 0; i<numberCount; i++) {
      ...
      luckyNumbers[i].addActionListener(mouseHandler);
